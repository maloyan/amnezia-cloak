...
// (Test fixtures below are single-line base64url URLs that intentionally exceed
// standard line-length limits — unwrapping them changes their content.)
import XCTest
